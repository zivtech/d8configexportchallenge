...
/**
 * @file
 * Contains \Drupal\google_map_field\Plugin\Field\FieldWidget\GoogleMapFieldDefaultWidget.
 */
...
class GoogleMapFieldDefaultWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['intro'] = array(
      '#type' => 'markup',
      '#markup' => t('<strong>Use the "Set Map Marker" button below to drop a marker on a map...</strong>'),
      '#prefix' => '<div>',
      '#suffix' => '</div>',
    );
